...
galaxy 'Zeus' do |g|
  system 'Athena', 'HR1925', :location => Location.new(:x => 240, :y => -360, :z => 110) do |sys|
    planet 'Posseidon',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.002,
                                                :eccentricity => 0.6, :semi_latus_rectum => 1770,
    ...
    planet 'Hades',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.011,
                                                :eccentricity => 0.9, :semi_latus_rectum => 1278,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Theodosia', 'ST9098', :location => Location.new(:x => 412, :y => -132, :z => 342) do |sys|
    planet 'Eukleides',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.046,
                                                :eccentricity => 0.21, :semi_latus_rectum => 1747,
                                                :direction => Motel.random_axis)

    planet 'Phoibe',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.005,
                                                :eccentricity => 0.1, :semi_latus_rectum => 1059,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Basilius',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.05,
                                                :eccentricity => 0.45, :semi_latus_rectum => 1710,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Leonidas',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.041,
                                                :eccentricity => 0.55, :semi_latus_rectum => 1097,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Pythagoras',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.03,
                                                :eccentricity => 0.66, :semi_latus_rectum => 1839,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Zeno',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.037,
                                                :eccentricity => 0.15, :semi_latus_rectum => 1664,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Galene',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.037,
                                                :eccentricity => 0.62, :semi_latus_rectum => 1031,
                                                :direction => Motel.random_axis)
  end
  ...
  system 'Nike', 'QR1515', :location => Location.new(:x => -222, :y => 333, :z => 413) do |sys|
    planet 'Nike I',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.065,
                                                :eccentricity => 0.12, :semi_latus_rectum => 1618,
                                                :direction => Motel.random_axis)
    planet 'Nike II',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.044,
                                                :eccentricity => 0.94, :semi_latus_rectum => 1408,
                                                :direction => Motel.random_axis)
    planet 'Nike III',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.019,
                                                :eccentricity => 0.42, :semi_latus_rectum => 1897,
                                                :direction => Motel.random_axis)
    planet 'Nike IV',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.063,
                                                :eccentricity => 0.13, :semi_latus_rectum => 1156,
                                                :direction => Motel.random_axis)
    planet 'Nike V',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.042,
                                                :eccentricity => 0.291, :semi_latus_rectum => 1670,
                                                :direction => Motel.random_axis)
    planet 'Nike VI',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.033,
                                                :eccentricity => 0.388, :semi_latus_rectum => 1715,
                                                :direction => Motel.random_axis)
    planet 'Nike VII',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.054,
                                                :eccentricity => 0.77, :semi_latus_rectum => 1117,
                                                :direction => Motel.random_axis)
    planet 'Nike VIII',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.034,
                                                :eccentricity => 0.22, :semi_latus_rectum => 1088,
                                                :direction => Motel.random_axis)
    planet 'Nike IX',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.044,
                                                :eccentricity => 0.32, :semi_latus_rectum => 1441,
                                                :direction => Motel.random_axis)
    planet 'Nike X',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.039,
                                                :eccentricity => 0.64, :semi_latus_rectum => 1894,
                                                :direction => Motel.random_axis)
  end

  system 'Philo', 'HU1792', :location => Location.new(:x => -142, :y => -338, :z => 409) do |sys|
    planet 'Theophila',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.047,
                                                :eccentricity => 0.88, :semi_latus_rectum => 1707,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Zosime',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.014,
                                                :eccentricity => 0.25, :semi_latus_rectum => 1503,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Xeno',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.036,
                                                :eccentricity => 0.16, :semi_latus_rectum => 1525,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Aphroditus', 'V867', :location => Location.new(:x => -420, :y => 119, :z => 90) do |sys|
    planet 'Xenux',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.062,
                                                :eccentricity => 0.8, :semi_latus_rectum => 1042,
                                                :direction => Motel.random_axis)
    planet 'Aesou',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.05,
  ...
  system 'Irene', 'HZ1279', :location => Location.new(:x => 110, :y => 423, :z => -455) do |sys|
    planet 'Irene I',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.062,
                                                :eccentricity => 0.29, :semi_latus_rectum => 1336,
                                                :direction => Motel.random_axis)
    planet 'Irene II',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.064,
                                                :eccentricity => 0.40, :semi_latus_rectum => 1587,
                                                :direction => Motel.random_axis)
    planet 'Korinna',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.028,
                                                :eccentricity => 0.71, :semi_latus_rectum => 1319,
                                                :direction => Motel.random_axis)
    planet 'Gaiane',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.024,
                                                :eccentricity => 0.68, :semi_latus_rectum => 1030,
                                                :direction => Motel.random_axis)
    planet 'Demetrius',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.015,
                                                :eccentricity => 0.223, :semi_latus_rectum => 1332,
                                                :direction => Motel.random_axis)
  end
  ...
  system 'Phokas', 'LO0032', :location => Location.new(:x => 112, :y => 485, :z => 165) do |sys|
    planet 'Akea',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.032,
                                                :eccentricity => 0.33, :semi_latus_rectum => 1838,
                                                :direction => Motel.random_axis) do |pl|
      moon 'Akea I',   :location => rand_location(:min => pl.size, :max => pl.size * 2.3)
    end

    planet 'Apukohai',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.068,
                                                :eccentricity => 0.53, :semi_latus_rectum => 1051,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Haulili',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.024,
                                                :eccentricity => 0.13, :semi_latus_rectum => 1787,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Hiaka',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.022,
                                                :eccentricity => 0.72, :semi_latus_rectum => 1767,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Kalaipahoa',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.065,
                                                :eccentricity => 0.39, :semi_latus_rectum => 1635,
                                                :direction => Motel.random_axis)
    planet 'Kamapua',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.044,
                                                :eccentricity => 0.65, :semi_latus_rectum => 1283,
                                                :direction => Motel.random_axis)

    planet 'Kamooalii',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.024,
                                                :eccentricity => 0.88, :semi_latus_rectum => 1649,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Kanaloa',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.019,
                                                :eccentricity => 0.45, :semi_latus_rectum => 1743,
                                                :direction => Motel.random_axis)

    planet 'Kane',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.031,
                                                :eccentricity => 0.88, :semi_latus_rectum => 1759,
                                                :direction => Motel.random_axis)

    planet 'Kapo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.044,
                                                :eccentricity => 0.32, :semi_latus_rectum => 1760,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Photina', 'A99G4', :location => Location.new(:x => 112, :y => 485, :z => 165) do |sys|
    planet 'Keuakepo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.033,
                                                :eccentricity => 0.50, :semi_latus_rectum => 1449,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Kiha',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.028,
                                                :eccentricity => 0.73, :semi_latus_rectum => 1357,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ku',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.069,
                                                :eccentricity => 0.13, :semi_latus_rectum => 1907,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Kaupe',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.019,
                                                :eccentricity => 0.13, :semi_latus_rectum => 1130,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Kuula',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.002,
                                                :eccentricity => 0.74, :semi_latus_rectum => 1467,
                                                :direction => Motel.random_axis)

    planet 'Laka',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.005,
                                                :eccentricity => 0.33, :semi_latus_rectum => 1367,
                                                :direction => Motel.random_axis)

    planet 'Lie',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.061,
                                                :eccentricity => 0.45, :semi_latus_rectum => 1540,
                                                :direction => Motel.random_axis)

    planet 'Lono',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.061,
                                                :eccentricity => 0.59, :semi_latus_rectum => 1170,
                                                :direction => Motel.random_axis) do |pl|
      moon 'Lono I',     :location => rand_location(:min => pl.size, :max => pl.size * 2.3)
    end

    planet 'Maui',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.003,
                                                :eccentricity => 0.82, :semi_latus_rectum => 1025,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ouli',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.059,
                                                :eccentricity => 0.48, :semi_latus_rectum => 1701,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Polihau',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.031,
                                                :eccentricity => 0.75, :semi_latus_rectum => 1620,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Papa',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.019,
                                                :eccentricity => 0.67, :semi_latus_rectum => 1070,
                                                :direction => Motel.random_axis)

    planet 'Pele',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.003,
                                                :eccentricity => 0.44, :semi_latus_rectum => 1265,
                                                :direction => Motel.random_axis)

    planet 'Uli',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.003,
                                                :eccentricity => 0.74, :semi_latus_rectum => 1212,
                                                :direction => Motel.random_axis)
  ...
  system 'Zosimus', 'GJ929J', :location => Location.new(:x => -122, :y => 553, :z => -194) do |sys|
    planet 'Airmid',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.052,
                                                :eccentricity => 0.74, :semi_latus_rectum => 1368,
                                                :direction => Motel.random_axis)

    planet 'Balor',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.027,
                                                :eccentricity => 0.92, :semi_latus_rectum => 1015,
                                                :direction => Motel.random_axis)

    planet 'Camalus',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.028,
                                                :eccentricity => 0.24, :semi_latus_rectum => 1763,
                                                :direction => Motel.random_axis)

    planet 'Druantia',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.055,
                                                :eccentricity => 0.42, :semi_latus_rectum => 1370,
                                                :direction => Motel.random_axis)

    planet 'Lugh',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.004,
                                                :eccentricity => 0.37, :semi_latus_rectum => 1460,
                                                :direction => Motel.random_axis)

    planet 'Llyr',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.044,
                                                :eccentricity => 0.74, :semi_latus_rectum => 1582,
                                                :direction => Motel.random_axis)

    planet 'Maeve',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.008,
                                                :eccentricity => 0.42, :semi_latus_rectum => 1084,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Mebd',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.068,
                                                :eccentricity => 0.76, :semi_latus_rectum => 1355,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Mider',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.035,
                                                :eccentricity => 0.79, :semi_latus_rectum => 1982,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Morrigan',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.01,
                                                :eccentricity => 0.24, :semi_latus_rectum => 1661,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Nemian',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.006,
                                                :eccentricity => 0.33, :semi_latus_rectum => 1623,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Aine',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.06,
                                                :eccentricity => 0.78, :semi_latus_rectum => 1913,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Anu',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.052,
                                                :eccentricity => 0.39, :semi_latus_rectum => 1467,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Demetrium', 'HGH902', :location => Location.new(:x => 342, :y => 95, :z => -98) do |sys|
    planet 'Bel',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.038,
                                                :eccentricity => 0.88, :semi_latus_rectum => 1527,
                                                :direction => Motel.random_axis)

    planet 'Bran',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.052,
                                                :eccentricity => 0.45, :semi_latus_rectum => 1830,
                                                :direction => Motel.random_axis)

    planet 'Bris',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.051,
                                                :eccentricity => 0.43, :semi_latus_rectum => 1954,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Dagda',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.038,
                                                :eccentricity => 0.57, :semi_latus_rectum => 1237,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Diancecht',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.012,
                                                :eccentricity => 0.69, :semi_latus_rectum => 1495,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Flidais',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.038,
                                                :eccentricity => 0.68, :semi_latus_rectum => 1974,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Dorisi', 'HF092N', :location => Location.new(:x => 34, :y => -33, :z => 34) do |sys|
    planet 'Macha',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.008,
                                                :eccentricity => 0.54, :semi_latus_rectum => 1296,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Niamh',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.068,
                                                :eccentricity => 0.42, :semi_latus_rectum => 1991,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Arawn',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.044,
                                                :eccentricity => 0.89, :semi_latus_rectum => 1658,
                                                :direction => Motel.random_axis)

    planet 'Blodeuwedd',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.04,
                                                :eccentricity => 0.17, :semi_latus_rectum => 1113,
                                                :direction => Motel.random_axis)

    planet 'Dewi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.012,
                                                :eccentricity => 0.74, :semi_latus_rectum => 1394,
                                                :direction => Motel.random_axis)

    planet 'Don',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.01,
                                                :eccentricity => 0.33, :semi_latus_rectum => 1330,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Syntyche', 'PP2942', :location => Location.new(:x => 432, :y => 646, :z => -174) do |sys|
    planet 'Dylan',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.014,
                                                :eccentricity => 0.93, :semi_latus_rectum => 1886,
                                                :direction => Motel.random_axis)

    planet 'Elaine',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.053,
                                                :eccentricity => 0.45, :semi_latus_rectum => 1026,
                                                :direction => Motel.random_axis)

    planet 'Gwydion',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.069,
                                                :eccentricity => 0.44, :semi_latus_rectum => 1070,
                                                :direction => Motel.random_axis)

    planet 'Myrrdin',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.012,
                                                :eccentricity => 0.78, :semi_latus_rectum => 1051,
                                                :direction => Motel.random_axis)
  ...
  system 'Aristocoles', 'GH29BV9', :location => Location.new(:x => 48, :y => -184, :z => -208) do |sys|
    planet 'Aizen-Myoo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.008,
                                                :eccentricity => 0.25, :semi_latus_rectum => 1794,
                                                :direction => Motel.random_axis)

    planet 'Amatsu-Kami',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.02,
                                                :eccentricity => 0.35, :semi_latus_rectum => 1415,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Butsu',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.064,
                                                :eccentricity => 0.45, :semi_latus_rectum => 1765,
                                                :direction => Motel.random_axis) do |pl|
...
galaxy 'Hera' do |g|
  system 'Agathon', 'JJ7192', :location => Location.new(:x => -88, :y => 219, :z => 499) do |sys|
    planet 'Tychon',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.012,
                                                :eccentricity => 0.33, :semi_latus_rectum => 1173,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Pegasus',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.031,
                                                :eccentricity => 0.42, :semi_latus_rectum => 1094,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Olympos',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.037,
                                                :eccentricity => 0.52, :semi_latus_rectum => 1317,
                                                :direction => Motel.random_axis)

    planet 'Zotikos',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.065,
                                                :eccentricity => 0.31, :semi_latus_rectum => 1985,
                                                :direction => Motel.random_axis)

    planet 'Zopyros',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.047,
                                                :eccentricity => 0.66, :semi_latus_rectum => 1834,
                                                :direction => Motel.random_axis)

    planet 'Kallisto',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.054,
                                                :eccentricity => 0.46, :semi_latus_rectum => 1555,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Isocrates', 'IL9091', :location => Location.new(:x => -104, :y => -399, :z => -438) do |sys|
    planet 'Isocrates I',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.021,
                                                :eccentricity => 0.42, :semi_latus_rectum => 1644,
                                                :direction => Motel.random_axis)

    planet 'Isocrates II',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.038,
                                                :eccentricity => 0.42, :semi_latus_rectum => 1545,
                                                :direction => Motel.random_axis)

    planet 'Isocrates III',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.031,
                                                :eccentricity => 0.42, :semi_latus_rectum => 1992,
                                                :direction => Motel.random_axis)
  end

  system 'Thais', 'QR1021', :location => Location.new(:x => 116, :y => 588, :z => -91) do |sys|
    planet 'Rhode',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.001,
                                                :eccentricity => 0.5, :semi_latus_rectum => 1960,
                                                :direction => Motel.random_axis)
  end
  ...
  system 'Lysander', 'V21', :location => Location.new(:x => 231, :y => 112, :z => 575) do |sys|
    planet 'Lysandra',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.051,
                                                :eccentricity => 0.46, :semi_latus_rectum => 1797,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Lysandrus',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.032,
                                                :eccentricity => 0.49, :semi_latus_rectum => 1820,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Lysandrene',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.061,
                                                :eccentricity => 0.66, :semi_latus_rectum => 1933,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Pelagia', 'HR1001', :location => Location.new(:x => -212, :y => -321, :z => 466) do |sys|
    planet 'Iason',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.016,
                                                :eccentricity => 0.48, :semi_latus_rectum => 1913,
                                                :direction => Motel.random_axis)
    planet 'Dionysius',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.066,
                                                :eccentricity => 0.69, :semi_latus_rectum => 1006,
                                                :direction => Motel.random_axis)
  end
  ...
  system 'Tycho', 'Q931', :location => Location.new(:x => 420, :y => -420, :z => 420) do |sys|
    planet 'Agape',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.013,
                                                :eccentricity => 0.16, :semi_latus_rectum => 1410,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Argyros',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.055,
                                                :eccentricity => 0.16, :semi_latus_rectum => 1438,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Kleon', 'ST223', :location => Location.new(:x => -112, :y => -642, :z => -119) do |sys|
    planet 'Chien-shin',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.002,
                                                :eccentricity => 0.33, :semi_latus_rectum => 1976,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Chup-Kamui',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.002,
                                                :eccentricity => 0.25, :semi_latus_rectum => 1479,
                                                :direction => Motel.random_axis)

    planet 'Daikoku',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.024,
                                                :eccentricity => 0.54, :semi_latus_rectum => 1554,
                                                :direction => Motel.random_axis)

    planet 'Dosojin',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.058,
                                                :eccentricity => 0.44, :semi_latus_rectum => 1451,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ebisu',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.016,
                                                :eccentricity => 0.35, :semi_latus_rectum => 1873,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Zenobia', 'ST812', :location => Location.new(:x => -598, :y => -575, :z => -204) do |sys|
    planet 'Fudo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.06,
                                                :eccentricity => 0.87, :semi_latus_rectum => 1312,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Fujin',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.05,
                                                :eccentricity => 0.88, :semi_latus_rectum => 1138,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Funadama',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.028,
                                                :eccentricity => 0.96, :semi_latus_rectum => 1655,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Gama',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.053,
                                                :eccentricity => 0.50, :semi_latus_rectum => 1319,
                                                :direction => Motel.random_axis)

    planet 'Hachiman',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.047,
                                                :eccentricity => 0.30, :semi_latus_rectum => 1261,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Hiruko',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.004,
                                                :eccentricity => 0.35, :semi_latus_rectum => 1079,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Hotei',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.033,
                                                :eccentricity => 0.67, :semi_latus_rectum => 1556,
                                                :direction => Motel.random_axis)

    planet 'Ida-Ten',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.042,
                                                :eccentricity => 0.56, :semi_latus_rectum => 1310,
                                                :direction => Motel.random_axis)
  end

  system 'Panther', 'ST0245', :location => Location.new(:x => -819, :y => 102, :z => 844) do |sys|
    planet 'Iki-Ryo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.023,
                                                :eccentricity => 0.69, :semi_latus_rectum => 1256,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Inari',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.037,
                                                :eccentricity => 0.89, :semi_latus_rectum => 1072,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Isora',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.004,
                                                :eccentricity => 0.84, :semi_latus_rectum => 1319,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Izanagi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.035,
                                                :eccentricity => 0.47, :semi_latus_rectum => 1080,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Izanami',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.018,
                                                :eccentricity => 0.28, :semi_latus_rectum => 1384,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Xenia', 'ST0482', :location => Location.new(:x => 193, :y => -339, :z => -449) do |sys|
    planet 'Kojin',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.054,
                                                :eccentricity => 0.84, :semi_latus_rectum => 1730,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Koshin',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.063,
                                                :eccentricity => 0.53, :semi_latus_rectum => 1033,
                                                :direction => Motel.random_axis) do |pl|
      moon 'Koshin I',    :location => rand_location(:min => pl.size, :max => pl.size * 2.3)
    end

    planet 'Kura-Okami',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.045,
                                                :eccentricity => 0.17, :semi_latus_rectum => 1788,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Miro',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.025,
                                                :eccentricity => 0.37, :semi_latus_rectum => 1588,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Nai-no-Kami',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.008,
                                                :eccentricity => 0.35, :semi_latus_rectum => 1992,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Nikko-Bosatsu",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.061,
                                                :eccentricity => 0.52, :semi_latus_rectum => 1251,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Nyorai",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.021,
                                                :eccentricity => 0.29, :semi_latus_rectum => 1999,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Thales', 'ST0572', :location => Location.new(:x => -953, :y => 285, :z => 475) do |sys|
    planet "Oanomochi",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.059,
                                                :eccentricity => 0.10, :semi_latus_rectum => 1381,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Oho-Yama",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.047,
                                                :eccentricity => 0.34, :semi_latus_rectum => 1194,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Owatatsumi",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.068,
                                                :eccentricity => 0.34, :semi_latus_rectum => 1062,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet "Raiden",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.02,
                                                :eccentricity => 0.29, :semi_latus_rectum => 1335,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Sengen",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.052,
                                                :eccentricity => 0.93, :semi_latus_rectum => 1461,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet "Shaka",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.047,
                                                :eccentricity => 0.11, :semi_latus_rectum => 1929,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet "Shichi",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.063,
                                                :eccentricity => 0.54, :semi_latus_rectum => 1931,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Shinda",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.024,
                                                :eccentricity => 0.58, :semi_latus_rectum => 1222,
                                                :direction => Motel.random_axis) do |pl|
      moon 'Shinda I',    :location => rand_location(:min => pl.size, :max => pl.size * 2.3)
    end

    planet "Shoden",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.029,
                                                :eccentricity => 0.35, :semi_latus_rectum => 1905,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet "Shoki",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.049,
                                                :eccentricity => 0.64, :semi_latus_rectum => 1152,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Nikias', 'ST875', :location => Location.new(:x => 305, :y => 438, :z => 308) do |sys|
    planet "Suijin",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.009,
                                                :eccentricity => 0.77, :semi_latus_rectum => 1557,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Suitengu",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.015,
                                                :eccentricity => 0.42, :semi_latus_rectum => 1501,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Susanowa",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.035,
                                                :eccentricity => 0.38, :semi_latus_rectum => 1279,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet "Takemikadzuchi",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.026,
                                                :eccentricity => 0.10, :semi_latus_rectum => 1500,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Tenjin",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.001,
                                                :eccentricity => 0.03, :semi_latus_rectum => 1141,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Tsuki-Yumi",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.023,
                                                :eccentricity => 0.45, :semi_latus_rectum => 1249,
                                                :direction => Motel.random_axis) do |pl|
    end
  ...
  system 'Metrodora', 'ST876', :location => Location.new(:x => 305, :y => 438, :z => 308) do |sys|
    planet "Uba",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.022,
                                                :eccentricity => 0.24, :semi_latus_rectum => 1719,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Uga-Jin",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.024,
                                                :eccentricity => 0.19, :semi_latus_rectum => 1663,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Ukemochi",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.03,
                                                :eccentricity => 0.99, :semi_latus_rectum => 1698,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet "Uzume",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.019,
                                                :eccentricity => 0.75, :semi_latus_rectum => 1637,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet "Yabune",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.029,
                                                :eccentricity => 0.53, :semi_latus_rectum => 1191,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Yamato",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.051,
                                                :eccentricity => 0.25, :semi_latus_rectum => 1983,
                                                :direction => Motel.random_axis) do |pl|
    end
  end
  ...
  system 'Lycus', 'ST022', :location => Location.new(:x => -254, :y => 459, :z => -335) do |sys|
    planet "Afa",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.065,
                                                :eccentricity => 0.12, :semi_latus_rectum => 1807,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet "Ao",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.022,
                                                :eccentricity => 0.53, :semi_latus_rectum => 1873,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Ara",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.025,
                                                :eccentricity => 0.459, :semi_latus_rectum => 1846,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet "Atea",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.027,
                                                :eccentricity => 0.19, :semi_latus_rectum => 1267,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Epaphras', 'ST230', :location => Location.new(:x => 554, :y => 244, :z => -495) do |sys|
    planet "Atua",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.038,
                                                :eccentricity => 0.56, :semi_latus_rectum => 1454,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet "Atutahi",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.069,
                                                :eccentricity => 0.33, :semi_latus_rectum => 1784,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Awha",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.014,
                                                :eccentricity => 0.59, :semi_latus_rectum => 1415,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Dhakhan",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.008,
                                                :eccentricity => 0.32, :semi_latus_rectum => 1833,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Julana",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.035,
                                                :eccentricity => 0.65, :semi_latus_rectum => 1683,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Eugina', 'ST011', :location => Location.new(:x => -334, :y => -53, :z => 45) do |sys|
    planet "Karora",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.026,
                                                :eccentricity => 0.43, :semi_latus_rectum => 1293,
                                                :direction => Motel.random_axis)
    planet "Njirana",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.039,
                                                :eccentricity => 0.89, :semi_latus_rectum => 1020,
                                                :direction => Motel.random_axis)
    planet "Pundjel",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.057,
                                                :eccentricity => 0.19, :semi_latus_rectum => 1934,
                                                :direction => Motel.random_axis)
    planet "Ungud",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.055,
                                                :eccentricity => 0.89, :semi_latus_rectum => 1001,
                                                :direction => Motel.random_axis)
    planet "Anjea",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.046,
                                                :eccentricity => 0.165, :semi_latus_rectum => 1668,
                                                :direction => Motel.random_axis)
    planet "Dilga",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.033,
                                                :eccentricity => 0.140, :semi_latus_rectum => 1460,
                                                :direction => Motel.random_axis)
    planet "Gnowee",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.057,
                                                :eccentricity => 0.33, :semi_latus_rectum => 1820,
                                                :direction => Motel.random_axis)
    0.upto(50){
      asteroid gen_uuid, :location => rand_location(:min => 250, :max => 1000, :min_y => 0) do |ast|
...
galaxy 'Thor' do |g|
  system 'Loki', 'B78915', :location => Location.new(:x => 57, :y => -530, :z => -116) do |sys|
    planet 'Hermod',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.01,
                                                :eccentricity => 0.45, :semi_latus_rectum => 1288,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Wala",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.068,
                                                :eccentricity => 0.67, :semi_latus_rectum => 1298,
                                                :direction => Motel.random_axis)

    planet "Yhi",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.053,
                                                :eccentricity => 0.59, :semi_latus_rectum => 1299,
                                                :direction => Motel.random_axis)
  ...
  system 'Heimdall', 'ABBA89', :location => Location.new(:x => 65, :y => -232, :z => 221) do |sys|
    planet 'Abaangui',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.049,
                                                :eccentricity => 0.35, :semi_latus_rectum => 1574,
                                                :direction => Motel.random_axis)

    planet 'Achi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.056,
                                                :eccentricity => 0.53, :semi_latus_rectum => 1892,
                                                :direction => Motel.random_axis)

    planet 'Achomawi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.004,
                                                :eccentricity => 0.35, :semi_latus_rectum => 1947,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Aguara',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.028,
                                                :eccentricity => 0.94, :semi_latus_rectum => 1176,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ahayuta',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.069,
                                                :eccentricity => 0.92, :semi_latus_rectum => 1765,
                                                :direction => Motel.random_axis)

    planet 'Ahea',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.017,
    ...
    planet 'Akna',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.027,
                                                :eccentricity => 0.47, :semi_latus_rectum => 1533,
                                                :direction => Motel.random_axis)

    planet 'Aluet',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.01,
                                                :eccentricity => 0.74, :semi_latus_rectum => 1921,
                                                :direction => Motel.random_axis)
  ...
  system 'Modi', 'FFBBA4', :location => Location.new(:x => 189, :y => 420, :z => -112) do |sys|
    planet 'Alignak',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.028,
                                                :eccentricity => 0.93, :semi_latus_rectum => 1440,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Alkuntam',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.056,
                                                :eccentricity => 0.41, :semi_latus_rectum => 1097,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Amala',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.045,
                                                :eccentricity => 0.27, :semi_latus_rectum => 1009,
                                                :direction => Motel.random_axis)

    planet 'Amitolane',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.035,
                                                :eccentricity => 0.72, :semi_latus_rectum => 1991,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Amotken',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.025,
                                                :eccentricity => 0.81, :semi_latus_rectum => 1270,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Anaye',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.001,
                                                :eccentricity => 0.10, :semi_latus_rectum => 1443,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Nanna', 'BCCC69', :location => Location.new(:x => -545, :y => 953, :z => 843) do |sys|
    planet 'Angalkuq',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.043,
                                                :eccentricity => 0.218, :semi_latus_rectum => 1855,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Angokoq',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.032,
                                                :eccentricity => 0.03, :semi_latus_rectum => 1395,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Anguta',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.021,
                                                :eccentricity => 0.98, :semi_latus_rectum => 1583,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Aningan',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.053,
                                                :eccentricity => 0.70, :semi_latus_rectum => 1538,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Apikunni',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.066,
                                                :eccentricity => 0.48, :semi_latus_rectum => 1343,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Apisirahts',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.001,
                                                :eccentricity => 0.70, :semi_latus_rectum => 1540,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Apotamkin',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.009,
                                                :eccentricity => 0.34, :semi_latus_rectum => 1660,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Fulla', 'DB0990', :location => Location.new(:x => 303, :y => 304, :z => -203) do |sys|
    planet 'Ataensic',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.017,
                                                :eccentricity => 0.68, :semi_latus_rectum => 1274,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Awanawilonais',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.064,
                                                :eccentricity => 0.67, :semi_latus_rectum => 1392,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Awonawilona',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.05,
                                                :eccentricity => 0.52, :semi_latus_rectum => 1804,
                                                :direction => Motel.random_axis)

    planet 'Badger',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.042,
                                                :eccentricity => 0.39, :semi_latus_rectum => 1028,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Begocidi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.004,
                                                :eccentricity => 0.73, :semi_latus_rectum => 1366,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Bikeh Hozho',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.01,
                                                :eccentricity => 0.93, :semi_latus_rectum => 1000,
                                                :direction => Motel.random_axis)

    planet 'Binaye Ahani',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.03,
                                                :eccentricity => 0.57, :semi_latus_rectum => 1976,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Nidhogg', 'DB0880', :location => Location.new(:x => -303, :y => -304, :z => 203) do |sys|
    ...
    planet 'Bototo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.05,
                                                :eccentricity => 0.42, :semi_latus_rectum => 1551,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Capa',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.028,
                                                :eccentricity => 0.64, :semi_latus_rectum => 1989,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Chacomat',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.057,
                                                :eccentricity => 0.49, :semi_latus_rectum => 1800,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Chacopa',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.04,
                                                :eccentricity => 0.31, :semi_latus_rectum => 1857,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Tyr', 'DDCB78', :location => Location.new(:x => 645, :y => 756, :z => 354) do |sys|
    ...
    planet 'Chibiabos',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.059,
                                                :eccentricity => 0.20, :semi_latus_rectum => 1819,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Chulyen',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.024,
                                                :eccentricity => 0.93, :semi_latus_rectum => 1010,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Dajoji',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.022,
                                                :eccentricity => 0.44, :semi_latus_rectum => 1026,
                                                :direction => Motel.random_axis)

    planet 'Dawn',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.044,
                                                :eccentricity => 0.48, :semi_latus_rectum => 1762,
                                                :direction => Motel.random_axis)

    planet 'Dayunsi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.033,
                                                :eccentricity => 0.57, :semi_latus_rectum => 1970,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Dohkwibuhch',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.004,
                                                :eccentricity => 0.20, :semi_latus_rectum => 1838,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Ran', 'DDCB77', :location => Location.new(:x => 755, :y => 656, :z => 200) do |sys|
    planet 'Doquebuth',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.016,
                                                :eccentricity => 0.76, :semi_latus_rectum => 1475,
                                                :direction => Motel.random_axis)

    planet 'Dzelarhons',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.004,
                                                :eccentricity => 0.42, :semi_latus_rectum => 1160,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Dzoavits',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.023,
                                                :eccentricity => 0.30, :semi_latus_rectum => 1567,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ehlaumel',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.06,
                                                :eccentricity => 0.74, :semi_latus_rectum => 1096,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Eithinoha',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.068,
                                                :eccentricity => 0.449, :semi_latus_rectum => 1334,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Var', 'DDCB76', :location => Location.new(:x => 834, :y => 578, :z => 253) do |sys|
    planet 'Enumclaw',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.036,
                                                :eccentricity => 0.40, :semi_latus_rectum => 1007,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Eototo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.05,
                                                :eccentricity => 0.28, :semi_latus_rectum => 1491,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Estanatlehi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.057,
                                                :eccentricity => 0.75, :semi_latus_rectum => 1294,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ewah',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.065,
                                                :eccentricity => 0.98, :semi_latus_rectum => 1610,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Ymi', 'DDCB75', :location => Location.new(:x => 776, :y => 644, :z => 344) do |sys|
    planet 'Ga Oh',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.05,
                                                :eccentricity => 0.34, :semi_latus_rectum => 1009,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Gaan',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.054,
                                                :eccentricity => 0.45, :semi_latus_rectum => 1566,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Gahe',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.061,
                                                :eccentricity => 0.53, :semi_latus_rectum => 1193,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Gaoh',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.016,
                                                :eccentricity => 0.64, :semi_latus_rectum => 1325,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Glooscap',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.044,
                                                :eccentricity => 0.42, :semi_latus_rectum => 1533,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Gluscabi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.066,
                                                :eccentricity => 0.43, :semi_latus_rectum => 1600,
                                                :direction => Motel.random_axis) do |pl|
...
galaxy 'Odin' do |g|
  system 'Asgrad', 'FE8331', :location => Location.new(:x => 253, :y => -753, :z => -112) do |sys|
    planet 'Guguyni',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.032,
                                                :eccentricity => 0.32, :semi_latus_rectum => 1979,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Haokah',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.005,
                                                :eccentricity => 0.63, :semi_latus_rectum => 1041,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Hemaskas',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.04,
                                                :eccentricity => 0.78, :semi_latus_rectum => 1542,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Hino',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.016,
                                                :eccentricity => 0.43, :semi_latus_rectum => 1148,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Hinu',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.005,
                                                :eccentricity => 0.82, :semi_latus_rectum => 1172,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ibofanga',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.048,
                                                :eccentricity => 0.21, :semi_latus_rectum => 1286,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Valhalla', 'FE9782', :location => Location.new(:x => -10, :y => -523, :z => -492) do |sys|
    planet 'Ictin',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.028,
                                                :eccentricity => 0.77, :semi_latus_rectum => 1441,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Ictinike',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.069,
                                                :eccentricity => 0.92, :semi_latus_rectum => 1365,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Igaluk',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.048,
                                                :eccentricity => 0.49, :semi_latus_rectum => 1807,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ikto',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.02,
                                                :eccentricity => 0.3, :semi_latus_rectum => 1713,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Iktomi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.054,
                                                :eccentricity => 0.55, :semi_latus_rectum => 1643,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ioi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.044,
                                                :eccentricity => 0.17, :semi_latus_rectum => 1582,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ioskeha',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.069,
                                                :eccentricity => 0.87, :semi_latus_rectum => 1424,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Hel', 'FE7334', :location => Location.new(:x => 57, :y => 115, :z => 432) do |sys|
    planet 'Isitoq',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.001,
                                                :eccentricity => 0.80, :semi_latus_rectum => 1847,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Iya',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.067,
                                                :eccentricity => 0.27, :semi_latus_rectum => 1521,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Kaiti',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.014,
                                                :eccentricity => 0.4, :semi_latus_rectum => 1070,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Kanati',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.032,
                                                :eccentricity => 0.37, :semi_latus_rectum => 1856,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Karwan',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.063,
                                                :eccentricity => 0.52, :semi_latus_rectum => 1757,
                                                :direction => Motel.random_axis) do |pl|
    end
  ...
  system 'Runic', 'FE7AA1', :location => Location.new(:x => 785, :y => 899, :z => 845) do |sys|
    planet 'Kioskurber',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.057,
                                                :eccentricity => 0.64, :semi_latus_rectum => 1812,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Kivati',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.01,
                                                :eccentricity => 0.84, :semi_latus_rectum => 1134,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Koko',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.018,
                                                :eccentricity => 0.89, :semi_latus_rectum => 1013,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Koyemsi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.04,
                                                :eccentricity => 0.97, :semi_latus_rectum => 1707,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Kumush',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.048,
                                                :eccentricity => 0.3, :semi_latus_rectum => 1584,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Kwatee',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.045,
                                                :eccentricity => 0.75, :semi_latus_rectum => 1626,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Kwatyat',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.003,
                                                :eccentricity => 0.63, :semi_latus_rectum => 1388,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Logobola',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.023,
                                                :eccentricity => 0.66, :semi_latus_rectum => 1164,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Saga', 'FE7AA2', :location => Location.new(:x => -822, :y => 910, :z => -734) do |sys|
    planet 'Maheo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.03,
                                                :eccentricity => 0.59, :semi_latus_rectum => 1436,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Malsum',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.051,
                                                :eccentricity => 0.4, :semi_latus_rectum => 1473,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Malsun',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.058,
                                                :eccentricity => 0.37, :semi_latus_rectum => 1277,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Mana',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.042,
                                                :eccentricity => 0.77, :semi_latus_rectum => 1119,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Jord', 'FE7AA3', :location => Location.new(:x => -999, :y => 456, :z => 650) do |sys|
    planet 'Manabozo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.045,
                                                :eccentricity => 0.59, :semi_latus_rectum => 1623,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Manabush',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.06,
                                                :eccentricity => 0.94, :semi_latus_rectum => 1789,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Manetto',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.032,
                                                :eccentricity => 0.64, :semi_latus_rectum => 1098,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Manisar',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.01,
                                                :eccentricity => 0.84, :semi_latus_rectum => 1325,
                                                :direction => Motel.random_axis) do |pl|
    end
  ...
  system 'Norn', 'FE7AA4', :location => Location.new(:x => 921, :y => 880, :z => -820) do |sys|
    planet 'Manit',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.039,
                                                :eccentricity => 0.56, :semi_latus_rectum => 1642,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Michabo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.029,
                                                :eccentricity => 0.52, :semi_latus_rectum => 1861,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Mising',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.05,
                                                :eccentricity => 0.37, :semi_latus_rectum => 1174,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Moar',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.042,
                                                :eccentricity => 0.59, :semi_latus_rectum => 1626,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Momo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.069,
                                                :eccentricity => 0.61, :semi_latus_rectum => 1804,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet "Na'pi",
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.044,
                                                :eccentricity => 0.4, :semi_latus_rectum => 1138,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Nanook',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.068,
                                                :eccentricity => 0.32, :semi_latus_rectum => 1658,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Napi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.043,
                                                :eccentricity => 0.4, :semi_latus_rectum => 1530,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Nataska',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.015,
                                                :eccentricity => 0.7, :semi_latus_rectum => 1051,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Nerivik',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.023,
                                                :eccentricity => 0.83, :semi_latus_rectum => 1769,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Nocoma',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.067,
                                                :eccentricity => 0.70, :semi_latus_rectum => 1741,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Nukatem',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.042,
                                                :eccentricity => 0.73, :semi_latus_rectum => 1862,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Ogres', 'FE7AA5', :location => Location.new(:x => 888, :y => -777, :z => -666) do |sys|
    planet 'Nunuso',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.053,
                                                :eccentricity => 0.7, :semi_latus_rectum => 1913,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ocasta',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.022,
                                                :eccentricity => 0.8, :semi_latus_rectum => 1991,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Olelbis',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.063,
                                                :eccentricity => 0.18, :semi_latus_rectum => 1205,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Onatah',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.069,
                                                :eccentricity => 0.12, :semi_latus_rectum => 1030,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Owiot',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.006,
                                                :eccentricity => 0.74, :semi_latus_rectum => 1314,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Pah',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.047,
                                                :eccentricity => 0.63, :semi_latus_rectum => 1444,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Ulle', 'FE7AA6', :location => Location.new(:x => 807, :y => -749, :z => 850) do |sys|
    planet 'Palhik Mana',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.042,
                                                :eccentricity => 0.76, :semi_latus_rectum => 1962,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Pamit',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.037,
                                                :eccentricity => 0.47, :semi_latus_rectum => 1870,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Poia',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.026,
                                                :eccentricity => 0.46, :semi_latus_rectum => 1942,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Qamaits',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.046,
                                                :eccentricity => 0.77, :semi_latus_rectum => 1635,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Quaayayp',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.024,
                                                :eccentricity => 0.55, :semi_latus_rectum => 1512,
                                                :direction => Motel.random_axis) do |pl|
    end
  ...
  system 'Njord', 'FE7AA7', :location => Location.new(:x => 909, :y => 808, :z => -853) do |sys|
    planet 'Raven',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.03,
                                                :eccentricity => 0.14, :semi_latus_rectum => 1504,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Rhpisunt',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.064,
                                                :eccentricity => 0.26, :semi_latus_rectum => 1026,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Sanopi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.055,
                                                :eccentricity => 0.62, :semi_latus_rectum => 1358,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Sedna',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.049,
                                                :eccentricity => 0.49, :semi_latus_rectum => 1444,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Syn', 'FE7AA8', :location => Location.new(:x => -935, :y => -942, :z => -908) do |sys|
    planet 'Selu',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.045,
                                                :eccentricity => 0.16, :semi_latus_rectum => 1302,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Senx',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.027,
                                                :eccentricity => 0.81, :semi_latus_rectum => 1351,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Shakaru',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.014,
                                                :eccentricity => 0.73, :semi_latus_rectum => 1281,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Sint Holo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.069,
                                                :eccentricity => 0.16, :semi_latus_rectum => 1350,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Sisiutl',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.045,
                                                :eccentricity => 0.84, :semi_latus_rectum => 1617,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Skan',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.057,
                                                :eccentricity => 0.53, :semi_latus_rectum => 1950,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Skadi', 'FE7AA9', :location => Location.new(:x => 993, :y => 922, :z => -807) do |sys|
    planet 'Skili',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.043,
                                                :eccentricity => 0.69, :semi_latus_rectum => 1412,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Snoqalm',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.044,
                                                :eccentricity => 0.75, :semi_latus_rectum => 1458,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Sotuknang',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.067,
                                                :eccentricity => 0.66, :semi_latus_rectum => 1036,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Szeukha',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.022,
                                                :eccentricity => 0.50, :semi_latus_rectum => 1915,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Tabaldak',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.009,
                                                :eccentricity => 0.70, :semi_latus_rectum => 1958,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Taiowa',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.028,
                                                :eccentricity => 0.26, :semi_latus_rectum => 1849,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Tamit',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.052,
                                                :eccentricity => 0.41, :semi_latus_rectum => 1240,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Tawiskara',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.057,
                                                :eccentricity => 0.11, :semi_latus_rectum => 1622,
                                                :direction => Motel.random_axis) do |pl|
    end
  ...
  system 'Surtr', 'FE7AAC', :location => Location.new(:x => 974, :y => -973, :z => 775) do |sys|
    planet 'Theelgeth',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.011,
                                                :eccentricity => 0.67, :semi_latus_rectum => 1604,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Tihtipihin',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.038,
                                                :eccentricity => 0.34, :semi_latus_rectum => 1680,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Tirawa',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.038,
                                                :eccentricity => 0.2, :semi_latus_rectum => 1768,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Tolmalok',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.031,
                                                :eccentricity => 0.91, :semi_latus_rectum => 1074,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Tonenili',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.014,
                                                :eccentricity => 0.54, :semi_latus_rectum => 1024,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Woden', 'FE7AAD', :location => Location.new(:x => 721, :y => 792, :z => -856) do |sys|
    planet 'Torngasak',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.022,
                                                :eccentricity => 0.33, :semi_latus_rectum => 1952,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Tsohanoai',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.041,
                                                :eccentricity => 0.31, :semi_latus_rectum => 1835,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Tukupar Itar',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.011,
                                                :eccentricity => 0.96, :semi_latus_rectum => 1682,
                                                :direction => Motel.random_axis) do |pl|
    end
  ...
  system 'Hermoda', 'FE7AAE', :location => Location.new(:x => -978, :y => -898, :z => -859) do |sys|
    planet 'Txamsem',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.055,
                                                :eccentricity => 0.21, :semi_latus_rectum => 1534,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Uncegila',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.067,
                                                :eccentricity => 0.29, :semi_latus_rectum => 1208,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Unelanuki',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.011,
                                                :eccentricity => 0.59, :semi_latus_rectum => 1160,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Unktome',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.062,
                                                :eccentricity => 0.70, :semi_latus_rectum => 1033,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Utset',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.054,
                                                :eccentricity => 0.85, :semi_latus_rectum => 1618,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Wabasso',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.016,
                                                :eccentricity => 0.47, :semi_latus_rectum => 1478,
                                                :direction => Motel.random_axis) do |pl|
    end
  ...
  system 'Hlin', 'FE7AAF', :location => Location.new(:x => -721, :y => 998, :z => 889) do |sys|
    planet 'Wakan Tanka',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.041,
                                                :eccentricity => 0.86, :semi_latus_rectum => 1277,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Wakanda',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.04,
                                                :eccentricity => 0.27, :semi_latus_rectum => 1329,
                                                :direction => Motel.random_axis) do |pl|
    end

    planet 'Wakonda',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.005,
                                                :eccentricity => 0.53, :semi_latus_rectum => 1337,
                                                :direction => Motel.random_axis) do |pl|
    end
...
galaxy 'Freya' do |g|
  system 'Fenrir', 'AA5521', :location => Location.new(:x => -323, :y => -360, :z => 369) do |sys|
    planet 'Gerd',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.054,
                                                :eccentricity => 0.45, :semi_latus_rectum => 1949,
                                                :direction => Motel.random_axis)

    planet 'Waukheon',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.037,
                                                :eccentricity => 0.51, :semi_latus_rectum => 1984,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Wendego',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.056,
                                                :eccentricity => 0.30, :semi_latus_rectum => 1954,
                                                :direction => Motel.random_axis)

    planet 'Wetiko',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.067,
                                                :eccentricity => 0.61, :semi_latus_rectum => 1424,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Weywot',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.043,
                                                :eccentricity => 0.41, :semi_latus_rectum => 1164,
                                                :direction => Motel.random_axis)
  ...
  system 'Vithar', 'BA4429', :location => Location.new(:x => -853, :y => 853, :z => 346) do |sys|
    planet 'Winabozho',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.03,
                                                :eccentricity => 0.48, :semi_latus_rectum => 1459,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Wisaaka',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.005,
                                                :eccentricity => 0.29, :semi_latus_rectum => 1087,
                                                :direction => Motel.random_axis)

    planet 'Wonomi',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.026,
                                                :eccentricity => 0.4, :semi_latus_rectum => 1731,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Xelas',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.002,
                                                :eccentricity => 0.78, :semi_latus_rectum => 1694,
                                                :direction => Motel.random_axis)
  end
  ...
  system 'Eir', 'ED0313', :location => Location.new(:x => -123, :y => 587, :z => 580) do |sys|
    planet 'Ah Puch',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.042,
                                                :eccentricity => 0.18, :semi_latus_rectum => 1696,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ahmakiq',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.035,
                                                :eccentricity => 0.37, :semi_latus_rectum => 1888,
                                                :direction => Motel.random_axis)

    planet 'Akhushtal',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.035,
                                                :eccentricity => 0.55, :semi_latus_rectum => 1796,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Bacabs',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.032,
                                                :eccentricity => 0.75, :semi_latus_rectum => 1655,
                                                :direction => Motel.random_axis)

    planet 'Centeotl',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.021,
                                                :eccentricity => 0.95, :semi_latus_rectum => 1933,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Chantico',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.006,
                                                :eccentricity => 0.48, :semi_latus_rectum => 1527,
                                                :direction => Motel.random_axis)

    planet 'Ehecatl',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.002,
                                                :eccentricity => 0.41, :semi_latus_rectum => 1123,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ekahau',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.035,
                                                :eccentricity => 0.76, :semi_latus_rectum => 1194,
                                                :direction => Motel.random_axis)
  end

  system 'Garm', 'AA3041', :location => Location.new(:x => 100, :y => 750, :z => 582) do |sys|
    planet 'Ix Chel',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.007,
                                                :eccentricity => 0.92, :semi_latus_rectum => 1900,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ixtab',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.002,
                                                :eccentricity => 0.61, :semi_latus_rectum => 1871,
                                                :direction => Motel.random_axis)

    planet 'Kan-u-Uayeyab',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.007,
                                                :eccentricity => 0.9, :semi_latus_rectum => 1653,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Kinich Kakmo',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.003,
                                                :eccentricity => 0.38, :semi_latus_rectum => 1788,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Kisin',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.013,
                                                :eccentricity => 0.60, :semi_latus_rectum => 1884,
                                                :direction => Motel.random_axis)

    planet 'Kukucan',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.015,
                                                :eccentricity => 0.26, :semi_latus_rectum => 1325,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Vili', 'DC5929', :location => Location.new(:x => 820, :y => -351, :z => 922) do |sys|
    planet 'Macuilxochitl',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.021,
                                                :eccentricity => 0.1, :semi_latus_rectum => 1943,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Mayahuel',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.038,
                                                :eccentricity => 0.21, :semi_latus_rectum => 1291,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Mictlan',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.065,
                                                :eccentricity => 0.44, :semi_latus_rectum => 1664,
                                                :direction => Motel.random_axis)

    planet 'Mitnal',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.058,
                                                :eccentricity => 0.34, :semi_latus_rectum => 1156,
                                                :direction => Motel.random_axis) do |pl|
  ...
  system 'Gunlad', 'FF2002', :location => Location.new(:x => 220, :y => 773, :z => -667) do |sys|
    planet 'Nacon',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.042,
                                                :eccentricity => 0.66, :semi_latus_rectum => 1743,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Ometecuhtli',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.023,
                                                :eccentricity => 0.21, :semi_latus_rectum => 1854,
                                                :direction => Motel.random_axis)
  end
  ...
  system 'Edda', 'FF3003', :location => Location.new(:x => -515, :y => -623, :z => -112) do |sys|
    planet 'Paynal',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.013,
                                                :eccentricity => 0.19, :semi_latus_rectum => 1432,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Quetzalcoatl',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.027,
                                                :eccentricity => 0.35, :semi_latus_rectum => 1077,
                                                :direction => Motel.random_axis) do |pl|
    ...
    planet 'Yaxche',
           :movement_strategy => Elliptical.new(:relative_to => Elliptical::RELATIVE_TO_FOCI, :speed => 0.002,
                                                :eccentricity => 0.33, :semi_latus_rectum => 1199,
                                                :direction => Motel.random_axis)
    0.upto(50){
      asteroid gen_uuid, :location => rand_location(:min => 250, :max => 1000, :min_y => 0) do |ast|
        resource :resource => rand_resource, :quantity => 1000
