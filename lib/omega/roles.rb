...
ENTITIES            = [ENTITIES_LOCATIONS, ENTITIES_COSMOS, ENTITIES_MANUFACTURED, ENTITIES_MANUFACTURED_RESOURCES,
                       ENTITIES_USERS, ENTITIES_USER, ENTITIES_USER_ATTRIBUTES, ENTITIES_PRIVILEGES,
                       ENTITIES_MISSIONS, ENTITIES_UNASSIGNED_MISSIONS, ENTITIES_MISSION_EVENTS]

ENTITYS             = [ENTITY_LOCATION,    ENTITY_COSMOS,   ENTITY_MANUFACTURED,
                       ENTITY_USERS,   ENTITY_USER,   ENTITY_MISSION,  ENTITY_USER_ATTRIBUTE]
