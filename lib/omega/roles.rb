...
ENTITIES            = [ENTITIES_LOCATIONS, ENTITIES_COSMOS, ENTITIES_MANUFACTURED, ENTITIES_MANUFACTURED_RESOURCES,
                       ENTITIES_USERS, ENTITIES_USER, ENTITIES_PRIVILEGES, ENTITIES_MISSIONS, ENTITIES_UNASSIGNED_MISSIONS, ENTITIES_MISSION_EVENTS]
ENTITYS             = [ENTITY_LOCATION,    ENTITY_COSMOS,   ENTITY_MANUFACTURED,   ENTITY_USERS,   ENTITY_USER,   ENTITY_MISSION]
...
ROLES = { :superadmin => PRIVILEGES.product(ENTITIES),
          ...
          :regular_user            => [[PRIVILEGE_VIEW, ENTITIES_COSMOS],    [PRIVILEGE_VIEW, ENTITIES_UNASSIGNED_MISSIONS], [PRIVILEGE_VIEW,   ENTITIES_MANUFACTURED], [PRIVILEGE_VIEW, ENTITIES_LOCATIONS]], # TODO doesn't take fog of war into account
          :anonymous_user          => [[PRIVILEGE_VIEW, ENTITIES_COSMOS],    [PRIVILEGE_VIEW, ENTITIES_UNASSIGNED_MISSIONS], [PRIVILEGE_VIEW,   ENTITIES_MANUFACTURED], [PRIVILEGE_VIEW, ENTITIES_LOCATIONS]]} # TODO pretty lax anonymous user
