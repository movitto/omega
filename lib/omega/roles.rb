...
ENTITIES            = [ENTITIES_LOCATIONS, ENTITIES_COSMOS, ENTITIES_MANUFACTURED, ENTITIES_MANUFACTURED_RESOURCES,
                       ENTITIES_USERS, ENTITIES_USER, ENTITIES_PRIVILEGES, ENTITIES_MISSIONS, ENTITIES_MISSION_EVENTS]
...
ROLES = { :superadmin => PRIVILEGES.product(ENTITIES),
          ...
          :regular_user            => [[PRIVILEGE_VIEW, ENTITIES_COSMOS],    [PRIVILEGE_VIEW,   ENTITIES_MANUFACTURED], [PRIVILEGE_VIEW, ENTITIES_LOCATIONS]], # TODO doesn't take fog of war into account
