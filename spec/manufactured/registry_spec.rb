...
describe Manufactured::Registry do
  ...
  it "should restore registered manufactured entities from io object" do
    s = '{"data":{"type":"mining","user_id":"user1","solar_system":{"data":{"star":null,"planets":[],"background":"system4","jump_gates":[],"location":{"data":{"restrict_view":true,"parent_id":null,"restrict_modify":true,"y":0,"movement_strategy":{"data":{"step_delay":1},"json_class":"Motel::MovementStrategies::Stopped"},"movement_callbacks":[],"children":[],"z":0,"proximity_callbacks":[],"id":null,"x":0},"json_class":"Motel::Location"},"asteroids":[],"name":null},"json_class":"Cosmos::SolarSystem"},"location":{"data":{"restrict_view":true,"parent_id":null,"restrict_modify":true,"y":0,"movement_strategy":{"data":{"step_delay":1},"json_class":"Motel::MovementStrategies::Stopped"},"movement_callbacks":[],"children":[],"z":0,"proximity_callbacks":[],"id":null,"x":0},"json_class":"Motel::Location"},"docked_at":null,"size":25,"notifications":[],"id":"ship1","resources":{}},"json_class":"Manufactured::Ship"}' + "\n" +
        '{"data":{"type":"exploration","user_id":"user1","solar_system":{"data":{"star":null,"planets":[],"background":"system4","jump_gates":[],"location":{"data":{"restrict_view":true,"parent_id":null,"restrict_modify":true,"y":0,"movement_strategy":{"data":{"step_delay":1},"json_class":"Motel::MovementStrategies::Stopped"},"movement_callbacks":[],"children":[],"z":0,"proximity_callbacks":[],"id":null,"x":0},"json_class":"Motel::Location"},"asteroids":[],"name":null},"json_class":"Cosmos::SolarSystem"},"location":{"data":{"restrict_view":true,"parent_id":null,"restrict_modify":true,"y":0,"movement_strategy":{"data":{"step_delay":1},"json_class":"Motel::MovementStrategies::Stopped"},"movement_callbacks":[],"children":[],"z":0,"proximity_callbacks":[],"id":null,"x":0},"json_class":"Motel::Location"},"docked_at":null,"size":23,"notifications":[],"id":"ship2","resources":{}},"json_class":"Manufactured::Ship"}' + "\n" +
        '{"data":{"type":"exploration","user_id":"user1","solar_system":{"data":{"star":null,"planets":[],"background":"system4","jump_gates":[],"location":{"data":{"restrict_view":true,"parent_id":null,"restrict_modify":true,"y":0,"movement_strategy":{"data":{"step_delay":1},"json_class":"Motel::MovementStrategies::Stopped"},"movement_callbacks":[],"children":[],"z":0,"proximity_callbacks":[],"id":null,"x":0},"json_class":"Motel::Location"},"asteroids":[],"name":null},"json_class":"Cosmos::SolarSystem"},"location":{"data":{"restrict_view":true,"parent_id":null,"restrict_modify":true,"y":0,"movement_strategy":{"data":{"step_delay":1},"json_class":"Motel::MovementStrategies::Stopped"},"movement_callbacks":[],"children":[],"z":0,"proximity_callbacks":[],"id":null,"x":0},"json_class":"Motel::Location"},"size":20,"id":"station","resources":{}},"json_class":"Manufactured::Station"}' + "\n" +
        '{"json_class":"Manufactured::Ship","data":{"id":"ship3","user_id":"user1","type":"battlecruiser","size":35,"hp":0,"attack_distance":100,"mining_distance":100,"docked_at":null,"attacking":null,"mining":null,"location":{"json_class":"Motel::Location","data":{"id":null,"x":0,"y":0,"z":0,"restrict_view":true,"restrict_modify":true,"parent_id":null,"children":[],"movement_strategy":{"json_class":"Motel::MovementStrategies::Stopped","data":{"step_delay":1}},"movement_callbacks":[],"proximity_callbacks":[]}},"system_name":null,"resources":{},"notifications":[]}}' + "\n"
    a = s.split "\n"
